...
const sumEveryOther = (...numeros) => numeros.reduce((prev, curr) => prev + curr);
...
const addOnlyNums = (...parametros) => {
    const filtrado = parametros.filter(e => typeof e === 'number')
    const resultado = filtrado.reduce((a, b) => a + b)
    return resultado
}
